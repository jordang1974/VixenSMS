...
using Vixen_Messaging.Properties;
	...
	class ThemeUpdateControls
	{
		...
		public static void UpdateControls(Control control, List<Control> excludes = null)
		{
			...
			foreach (Control c in control.Controls)
			{
				...
				if (c is GroupBox | c is Panel | c is Label | c is ToolStrip | c is RadioButton | c is CheckBox | c is TreeView | c.ToString().Contains("PropertyGrid"))
				{
				...
				//	btn.BackColor = ThemeColorTable.TextBoxBackgroundColor;
				//	btn.ForeColor = ThemeColorTable.ForeColor;
				//	btn.CalendarMonthBackground = ThemeColorTable.TextBoxBackgroundColor;
				//	btn.CalendarForeColor = ThemeColorTable.ForeColor;
				//}
				if (c is ListBox | c is ListView | c is RichTextBox)
				{
